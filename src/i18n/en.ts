...
export const dict = {
    title: "Remova",
    subtitle: "Deep uninstall — clean and explainable",
    search: "Search apps…",
    history: "History",
    ...
    selectRowHint: "Click a software row in the list first",
    ...
    versionCheckHint: "Check online for a newer version",
    ...
    adminChipHint: "Not elevated. Click when changing startup items or system services.",
    errElevateDenied:
    ...
    moreSectionCommonHint: "History, restore backups, manage the ignore list",
    moreSectionAdvancedHint: "Watch what an installer writes so uninstall stays complete",
    ...
    appWhitelistHint: "Manage ignored apps/publishers — remove an entry to show it again",
    whitelistRemove: "Remove",
    manageReload: "Reload",
    manageClose: "Close manage",
    forceClean: "Force clean leftovers",
    forceCleanHint: "Clean what official uninstall left behind. Skips the vendor uninstaller; deletes only what you confirm (backup optional)",
    ...
    orphanScan: "Find orphan leftovers",
    orphanScanning: "Looking for orphan leftovers…",
    ...
    historyHint: "What you uninstalled or cleaned before, and whether it worked",
    exportCsvHint: "Export cleanup history as CSV",
    restoreHint: "Undo a cleanup using a backup you saved before deleting",
    manageHint: "Manage startup items, services, and tasks",
    manageCloseHint: "Close the manage panel",
    ignorePublisherHint: "Add this publisher to the ignore list so scans skip it",
    ignoreAppHint: "Add this app to the ignore list so scans skip it",
    orphanScanHint: "Find leftover folders with no matching install record",
    monitorInstallHint: "Start, install the app, then finish. See what it wrote so uninstall can clean later",
    monitorStopHint: "Done installing — stop recording and list the changes",
    ...
    orphanNoOwnerHint: "Cannot tell which app owns this — review before deleting",
    orphanReasonDefault: "Looks like a leftover folder: no install record left",
