...
export const dict: EnDict = {
    ...
    orphanShowAll: (n: number) => `Show all ${n} items`,
    orphanShowLess: "Show less",
    ...
    aiErrHttp: "AI endpoint unreachable — check your network and base URL",
    aiErrKeyEmpty: "AI API key is not configured — set it in AI settings",
    aiErrModelEmpty: "AI model name is not configured — set it in AI settings",
    aiErrEmpty: "AI returned an empty response — try again",
    aiErrParse: "Failed to parse the AI response — check endpoint compatibility",
    badgeShared: "Shared",
    ...
    copilotRunBatchN: (n: number) => `Batch uninstall these ${n} app(s) (extra confirm)`,
    copilotRunForceN: (name: string) => `Force-clean "${name}" (extra confirm)`,
