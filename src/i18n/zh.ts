...
export const dict = {
    ...
    rescanAfterUninstallHint: "官方卸载成功后自动深度扫描，检查是否产生新残留（默认开启）",
    ...
    moreSectionCommonHint: "清理记录、备份还原与忽略名单",
    moreSectionAdvancedHint: "闲置、磁盘、安装包、专项缓存与安装追踪",
    idleTitle: "闲置软件雷达",
    idleHint: "找出长期未动、占用偏大的软件（只建议，去软件列表卸载）",
    idleEmpty: "没有明显的闲置候选",
    idleDays: (d: number) => `闲置约 ${d} 天`,
    idleEvInstallAge: "安装日期",
    idleEvDirMtime: "目录最近改动",
    diskSizeApprox: (s: string) => `约 ${s}`,
    ...
    ignorePub: "忽略发布者",
    appWhitelist: "应用白名单",
    appWhitelistHint: "管理已忽略的软件与发布者，可移除以恢复显示",
    whitelistRemove: "移除",
    manageReload: "刷新",
    manageClose: "关闭管理",
    forceClean: "强制清理残留",
    ...
    historyHint: "查看历史清理记录与成功/失败情况",
    exportCsvHint: "将清理历史导出为 CSV 文件",
    restoreHint: "从备份会话还原文件与注册表",
    manageHint: "管理启动项、服务、计划任务",
    manageCloseHint: "关闭管理面板",
    ignorePublisherHint: "将该软件发布者加入忽略列表",
    ignoreAppHint: "将当前选中的软件加入忽略列表",
    orphanScanHint: "扫描无对应安装记录的残留目录与快捷方式",
    monitorInstallHint: "记录安装过程中的文件系统变更，结束后可查看改动清单",
    monitorStopHint: "结束本次安装追踪并生成变更清单",
    exportReportHint: "将当前分析报告导出为 HTML",
