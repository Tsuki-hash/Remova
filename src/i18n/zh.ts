...
export const dict = {
    ...
    rescanAfterUninstallHint: "卸载完成后自动再扫一遍，看看还有没有残留（建议保持开启）",
    ...
    historyTitle: "清理历史",
    errorDismiss: "知道了",
    adminHint: "当前权限较低，清理系统软件可能失败。点这里以管理员身份重新打开。",
    adminAlready: "已是管理员。",
    elevateAskTitle: "需要管理员权限",
    elevateAskBody:
      "修改服务、系统启动项或清理系统目录时需要管理员权限。将以管理员身份重启 Remova（界面会短暂关闭），继续？",
    elevateAskOk: "以管理员重启",
    adminChipHint: "当前不是管理员。管理开机启动/系统服务时建议点此提权",
    errElevateDenied:
    ...
    moreSectionCommonHint: "看记录、恢复备份、管理忽略名单",
    moreSectionAdvancedHint: "追踪一次安装写了什么，方便以后卸干净",
    detailHide: "收起详情",
    detailShow: "详情",
    ...
    ignorePub: "忽略发布者",
    appWhitelist: "应用白名单",
    appWhitelistHint: "管理已忽略的软件/发布者，可随时移除恢复显示",
    whitelistRemove: "移除",
    manageReload: "刷新",
    manageClose: "关闭管理",
    forceClean: "强制清理残留",
    forceCleanHint: "官方卸载后仍留下的东西在这里清。会跳过官方卸载器，只删你确认过的残留（可先备份）",
    shellMenu: "注册右键菜单",
    shellMenuOn: "已注册右键菜单",
    ...
    winRestore: "还原",
    winClose: "关闭",
    dropHint: "也可以把 exe 或安装文件夹拖进窗口来分析",
    ignorePublisher: "忽略发布者",
    ignoreApp: "忽略此软件",
    ignoreLoaded: "已应用忽略规则",
    exportReport: "导出报告",
    orphanScan: "查找无主残留",
    orphanScanning: "正在查找无主残留…",
    ...
    historyHint: "以前卸载/清理过哪些软件，成功还是失败",
    exportCsvHint: "将清理历史导出为 CSV 文件",
    restoreHint: "清理前若做了备份，可在这里恢复误删的文件",
    manageHint: "管理启动项、服务、计划任务",
    manageCloseHint: "关闭管理面板",
    ignorePublisherHint: "把该软件的发行商加入忽略名单，以后扫描不再出现",
    ignoreAppHint: "把当前选中的软件加入忽略名单，以后扫描不再出现",
    orphanScanHint: "找出磁盘上「已经没有安装记录」的残留文件夹，适合清理卸载不干净或绿色软件留下的东西",
    monitorInstallHint: "先点开始 → 去装软件 → 再点结束。会列出这次安装新建/改动的文件和设置，以后卸载就心里有数",
    monitorStopHint: "装完软件了，停止记录并生成改动清单",
    exportReportHint: "把当前残留分析结果保存成网页文件，方便存档或发给别人",
    ...
    orphanNoOwnerHint: "看不出属于哪个软件，建议一条条看清楚再删",
    orphanReasonDefault: "像是残留目录：系统里已没有对应的安装记录",
    ...
    smartFilterExamplesTitle: "试试这样说",
    smartFilterExample1: "大于 2GB 的 Adobe",
    smartFilterExample2: "最近安装的软件",
    smartFilterExample3: "可能是残留的软件",
    smartFilterExample4: "带有启动项的程序",
