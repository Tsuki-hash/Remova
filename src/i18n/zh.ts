...
export const dict = {
    ...
    orphanShowAll: (n: number) => `显示全部 ${n} 项`,
    orphanShowLess: "收起列表",
    ...
    aiRiskTitle: "风险说明",
    aiFailed: "智能解释暂时不可用",
    aiErrHttp: "AI 服务连接失败，请检查网络与端点地址",
    aiErrKeyEmpty: "未配置 AI API Key，请到 AI 设置中填写",
    aiErrModelEmpty: "未配置 AI 模型名称，请到 AI 设置中填写",
    aiErrEmpty: "AI 返回了空响应，请稍后重试",
    aiErrParse: "AI 响应解析失败，请检查端点是否兼容",
    badgeShared: "共享",
    ...
    copilotRunBatchN: (n: number) => `批量卸载这 ${n} 项（将再次确认）`,
    copilotRunForceN: (name: string) => `强制清理「${name}」（将再次确认）`,
