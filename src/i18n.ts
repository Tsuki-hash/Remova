...
const dict = {
  zh: {
    ...
    aiSettings: "AI 详细说明",
    aiSettingsHint: "在扫描结果里用更易懂的话解释残留与风险；不执行删除",
    aiEnable: "启用智能说明",
    aiProvider: "服务商",
    ...
    copilotNeedAiOld: "请先在「更多 → 详细说明」启用",
    ...
    conclusionRefreshAi: "重新生成 AI 解读",
    conclusionEnableAi: "启用 AI 详细说明",
    badgeNew: "新",
    badgeRunning: "运行中",
    firstScanAiHint: "想让结论更口语？点右上「AI 未启用」配置本地 Ollama 或云端模型（不执行删除）。",
    ...
    aiEnabledChip: "AI 已启用",
    aiDisabledChip: "AI 未启用",
